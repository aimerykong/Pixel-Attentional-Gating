function [netbasemodel, lName] = insertScaleAttentionPyramidModule_Gumbel(netbasemodel, inDim, poolScaleList, sName, namePrefix)
...
lName = sprintf('%s_AttentionSoftmax', namePrefix);
% netbasemodel.addLayer(lName, dagnn.SoftMax(), sName, lName);
netbasemodel.addLayer(lName, GumbelNoisySoftMax('t',0.1), sName, lName);
...
sNameList{end+1} = sprintf('%s_AttentionSoftmax', namePrefix);
